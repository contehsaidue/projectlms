<?php include 'dashboard-sidebar.php';?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h4 class="h2 fst-italic fw-bold">Books Returned
...
<?php 
      ...
      <table class="table table-striped table-bordered table-hover table-responsive" style="font-size:12px" cellspacing="0">
          ...
          <?php
            ...
            $datashowquery = "SELECT DISTINCT * FROM tblbookreturn
            JOIN tblbook ON tblbook.bookid = tblbookreturn.book_ID 
           JOIN tblstudent ON tblstudent.stud_ID = tblbookreturn.stud_ID";

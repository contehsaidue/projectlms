      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <button type="button" class="btn btn-sm btn-success fw-bold fst-italic" data-bs-toggle="modal" data-bs-target="#addcategorymodal">Add Book Category</button>
          </div>
        </div>
      </div>
  <!-- Feedback Message -->
...
<div class="form-group mb-3">
 ...
 <button class="btn btn-success btn-sm fw-bold fst-italic" name="addbookcategory">Add Category <i class="fas fa-book"></i></button>

<?php include 'dashboard-sidebar.php';?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h4 class="h2 fst-italic fw-bold">Library
             <img src="../assets/LMS Icons/2.png" width="40" height="32"></h4>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <button type="button" class="btn btn-sm btn-success fw-bold fst-italic" data-bs-toggle="modal" data-bs-target="#addbookmodal">Place Book Query</button>
          </div>
        </div>
      </div>
<!-- Feedback Message -->
          ...
          <?php
            ...
            <tr>
              ...
              <td>
                ...
                <button class="btn btn-dark btn-sm fw-bold fst-italic" type="submit" name="borrowbook"> Borrow <img src="../assets/LMS Icons/2.png" width="35" height="25"></button>
                </form>
            </td>
            </tr>
            <?php
...
<?php include 'dashboard-footer.php';?>
  ...
  <div class="modal fade" id="addbookmodal">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-bold fst-italic">    
    <img src="../assets/LMS Icons/225932.png" width="40" height="32"> Place Book Query</h5>
</div>
 ...
 <button class="btn btn-success btn-sm fw-bold fst-italic" name="adminaddbook">Place Query <i class="fas fa-marker"></i></button>
